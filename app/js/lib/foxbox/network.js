...
export default class Network {
  ...
  get localOrigin() {
    return `${this.settings.localScheme}://${this.settings.localHostname}:${this.settings.localPort}`;
  }

  get tunnelOrigin() {
    return `${this.settings.tunnelScheme}://${this.settings.tunnelHostname}:${this.settings.tunnelPort}`;
  }
